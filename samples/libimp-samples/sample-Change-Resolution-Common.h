...
extern int sample_res_encoder_param_default(IMPEncoderChnAttr *chnAttr, IMPEncoderProfile profile, IMPEncoderRcMode rcMode,
...
extern int sample_res_do_get_stream(int enc_chn_num, char *path, IMPEncoderProfile profile, int nr_frames);
