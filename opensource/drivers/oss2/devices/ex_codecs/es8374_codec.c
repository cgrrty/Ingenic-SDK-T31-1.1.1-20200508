    	...
    	case 6: //12000
    		...
    		*/
    		...
    		es8374_reg_set(0x09, 0, 7, 0x01); //pll set:reset on ,set start
				...
				es8374_reg_set(0x06, 0, 7, 0x01); //LRCK div =0400H = 1024D, lrck = 12.288M/1024 = 12K
				es8374_reg_set(0x07, 0, 7, 0x00);
				es8374_reg_set(0x0f, 0, 7, 0x84); //bclk = mclk/ 16 = 768K
				es8374_dac_mute(0);
				break;
    	case 5: //16000
    		/*
		...
		case 2: //44100;
     	...
     	case 0: //96000
    		...
    		*/
				...
				es8374_reg_set(0x06, 0, 7, 0x01); //LRCK div =0080H = 128D, lrck = 12.288M/128 = 96K
				es8374_reg_set(0x07, 0, 7, 0x00);
				es8374_reg_set(0x0f, 0, 7, 0x84);  //bclk = mclk/ 2 = 6144k
				es8374_dac_mute(0);
				break;
    	default:
