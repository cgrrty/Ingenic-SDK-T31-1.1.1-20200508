...
#ifndef __CONFIG_BOOTES_H__
#define __CONFIG_BOOTES_H__
 ...
 */
#define BOOTARGS_COMMON "console=ttyS2,115200n8 mem=36M@0x0 ispmem=8M@0x2400000 rmem=20M@0x2c00000"
...
/* #define MTDIDS_DEFAULT		"nor0=jz_sfc" */
/* #define MTDPARTS_DEFAULT	"mtdparts=jz_sfc:256k(boot),3840k(kernel),8192k(rootfs),4096k(data)" */

#ifdef CONFIG_SPL_MMC_SUPPORT
#define CONFIG_BOOTARGS BOOTARGS_COMMON " init=/linuxrc root=/dev/mmcblk0p2 rw rootdelay=1 mtdparts=jz_sfc:256k(boot),3840k(kernel),8192k(rootfs),4096k(data)"
#elif CONFIG_SFC_NOR
#ifdef CONFIG_SFC_NOR_16M
#define CONFIG_BOOTARGS BOOTARGS_COMMON " init=/linuxrc rootfstype=jffs2 root=/dev/mtdblock2 rw mtdparts=jz_sfc:256k(boot),3840k(kernel),8192k(rootfs),4096k(data)"
#elif CONFIG_SFC_NOR_8M
#define CONFIG_BOOTARGS BOOTARGS_COMMON " init=/linuxrc rootfstype=squashfs root=/dev/mtdblock2 rw mtdparts=jz_sfc:256k(boot),3840k(kernel),1024k(rootfs),2560k(appfs),512k(data)"
#elif CONFIG_SFC_NOR_4M
#define CONFIG_BOOTARGS BOOTARGS_COMMON " init=/linuxrc rootfstype=squashfs root=/dev/mtdblock2 rw"
#else
...
#ifdef CONFIG_SFC_NOR_16M
#define CONFIG_BOOTCOMMAND "sf probe;sf read 0x80600000 0x40000 0x3c0000; bootm 0x80600000"
#elif CONFIG_SFC_NOR_8M
#define CONFIG_BOOTCOMMAND "sf probe;sf read 0x80600000 0x28000 0x300000; bootm 0x80600000"
#elif CONFIG_SFC_NOR_4M
#define CONFIG_BOOTCOMMAND "sf probe;sf read 0x80600000 0x28000 0x300000; bootm 0x80600000"
#else
#define CONFIG_BOOTCOMMAND "sf probe;sf read 0x80600000 0x40000 0x3c0000; bootm 0x80600000"
#endif /* CONFIG_SFC_NOR_16M */
#endif /* CONFIG_SFC_NOR */
/**
...
#if !defined(CONFIG_SFC_NOR_8M) && !defined(CONFIG_SFC_NOR_4M)
#define CONFIG_GENERIC_MMC		1
#define CONFIG_MMC			1
#define CONFIG_JZ_MMC			1
#endif /* CONFIG_SFC_NOR_8M  && CONFIG_SFC_NOR_4M*/
...
#define CONFIG_GPIO_IP101G_POWER	GPIO_PA(22)
#define CONFIG_GPIO_IP101G_POWER_ENLEVEL	0

#define CONFIG_GPIO_IP101G_RESET	GPIO_PB(20)
...
#define CONFIG_ENV_OFFSET		(224 * 1024)
#else
