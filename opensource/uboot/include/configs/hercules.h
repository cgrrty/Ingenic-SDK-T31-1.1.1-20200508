...
#ifndef __CONFIG_HERCULES_H__
#define __CONFIG_HERCULES_H__
...
#define CONFIG_SYS_MPLL_FREQ		792000000	/*If MPLL not use mast be set 0*/
...
#define CONFIG_DDR3_H5TQ2G63BFR_H9C
#else
#define CONFIG_DDR_PARAMS_CREATOR
#define CONFIG_DDR_HOST_CC
#define CONFIG_DDR_FORCE_SELECT_CS1
...
#define CONFIG_DDR_CS1			0	/* 1-connected, 0-disconnected */
#define CONFIG_DDR_DW32			1	/* 1-32bit-width, 0-16bit-width */
#define CONFIG_DDR2_PWE809416BBR_E7DN
...
#define CONFIG_BOOTARGS BOOTARGS_COMMON " init=/linuxrc root=/dev/mmcblk0p3 ro rootdelay=1"
#elif CONFIG_SFC_NOR
...
#define CONFIG_GPIO_8710A_RESET	GPIO_PB(20)
#define CONFIG_GPIO_8710A_RESET_ENLEVEL	0
/* DEBUG ETHERNET */
