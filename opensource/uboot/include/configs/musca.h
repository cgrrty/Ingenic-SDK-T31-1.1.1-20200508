...
#define CONFIG_SYS_APLL_FREQ		983040000	/*If APLL not use mast be set 0*/
#define CONFIG_SYS_APLL_FRAC		0xeb851e
#define CONFIG_SYS_APLL_MNOD		((81 << 20) | (2 << 14) | (1 << 11) | (1 << 8))
...
#define BOOTARGS_COMMON "console=ttyS1,115200n8 mem=36M@0x0 ispmem=8M@0x2400000 rmem=20M@0x2c00000"
	...
	#define CONFIG_BOOTARGS BOOTARGS_COMMON " init=/linuxrc root=/dev/mmcblk0p2 rw rootdelay=1"
		...
		#define CONFIG_BOOTARGS BOOTARGS_COMMON " init=/linuxrc rootfstype=jffs2 root=/dev/mtdblock2 rw mtdparts=jz_sfc:256k(boot),3840k(kernel),12288k(rootfs)"
	#elif CONFIG_SFC_NOR_8M
		#define CONFIG_BOOTARGS BOOTARGS_COMMON " init=/linuxrc rootfstype=jffs2 root=/dev/mtdblock2 rw mtdparts=jz_sfc:256k(boot),3840k(kernel),4096k(rootfs)"
