...
struct cgu cgu_clk_sel[CGU_CNT] = {
	...
	[GMAC] = {1, CPM_GMACCDR, 31, APLL, {APLL, EPLL, -1, -1}, 29, 28, 27},
	[MACPHY] = {1, CPM_MACCDR, 31, APLL, {APLL, EPLL, -1, -1}, 29, 28, 27},
	[MSC] = {1, CPM_MSC0CDR, 31, APLL, {APLL, VPLL, -1, -1}, 29, 28, 27},
	[BCH] = {1, CPM_BCHCDR, 31, CONFIG_CPU_SEL_PLL, {APLL, MPLL, -1, -1}, 29, 28, 27},
	[VPU] = {1, CPM_VPUCDR, 30, MPLL, {APLL, MPLL, VPLL, -1}, 29, 28, 27},
	[I2S] = {1, CPM_I2SCDR, 30, EXCLK, {APLL, MPLL, EXCLK, -1}, 29, 28, 27},
	[LCD] = {1, CPM_LPCDR,  31, CONFIG_CPU_SEL_PLL, {APLL, VPLL, -1, -1}, 28, 27, 26},
	[MSC1] = {0, CPM_MSC1CDR, 0, 0, {-1, -1, -1, -1}, 29, 28, 27},
	[MSC2] = {0, CPM_MSC2CDR, 0, 0, {-1, -1, -1, -1}, 29, 28, 27},
	[UHC] = {1, CPM_UHCCDR, 31, USBPHY, {APLL, USBPHY, -1, -1}, 29, 28, 27},
#ifdef CONFIG_BURNER
	[SSI] = {1, CPM_SSICDR, 30, EXCLK, {APLL, MPLL, EXCLK, -1}, 29, 28, 27},
#else
	[SSI] = {1, CPM_SSICDR, 30, CONFIG_CPU_SEL_PLL, {APLL, MPLL, EXCLK, -1}, 29, 28, 27},
#endif
	[CIM] = {1, CPM_CIMCDR, 31, APLL, {APLL, VPLL, -1, -1}, 30, 29, 28},
	[PCM] = {1, CPM_PCMCDR, 30, CONFIG_CPU_SEL_PLL, {APLL, MPLL, EXCLK, -1}, 28, 27, 26},
	[ISP] = {1, CPM_ISPCDR, 31, APLL, {APLL, VPLL, -1, -1}, 29, 28, 27},
};
